...
Object.keys(indexMiddleware).forEach(key => {
  if (typeof indexMiddleware[key] === 'function' && key !== 'csrfProtection') {
    const originalMiddleware = indexMiddleware[key];
    indexMiddleware[key] = (req, res, next) => {
      try {
